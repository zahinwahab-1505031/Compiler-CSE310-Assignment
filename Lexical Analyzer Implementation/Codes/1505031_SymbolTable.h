...
public:
    ...
    bool Insert(string SymbolType,string SymbolName)
    {
    ...
    void Print()
    {
        ...
        for(int i=0; i<SIZE; i++)
        {
            ...
            {
                string a = table[i]->getSymbolName();
                string b = table[i]->getSymbolType();
                int len =a.size();
                char a1[len+1];
                for(int k=0; k<len; k++) a1[k] = a[k];
	        a1[len] = '\0';
                len =b.size();
                char b1[len+1];
                for(int k=0; k<len; k++) b1[k] = b[k];
b1[len] = '\0';
            ...
            if(table[i]!=NULL&&table[i]->next!=NULL)
            {
                ...
                string a = temp->getSymbolName();
                string b = temp->getSymbolType();
               int len =a.size();
                char a1[len+1];
                for(int k=0; k<len; k++) a1[k] = a[k];
	        a1[len] = '\0';
